package br.com.rafaelvieira.taskmanagement.integration.controller;
...
class TaskControllerIntegrationTest extends BaseIntegrationTest {
    ...
    void testShouldReturn400WhenTitleIsBlank() throws Exception {
        TaskCreateRecord create =
                new TaskCreateRecord(
                        "", "Description", TaskStatus.TODO, Priority.MEDIUM, null, null, null);
    ...
    void testShouldGetAllTasks() throws Exception {
        ...
        mockMvc.perform(get("/api/tasks"))
                ...
                .andExpect(
                        jsonPath("$[*].title", containsInAnyOrder("Task 1", "Task 2", "Task 3")));
    }
