...
public class TaskServiceImpl implements TaskService {
        ...
        private void pauseMainTimer(Task task) {
                if (task.getMainStartedAt() != null) {
                        long delta = java.time.Duration.between(task.getMainStartedAt(), LocalDateTime.now())
                                        .getSeconds();
        ...
        private void maybeStartPomodoro(Task task) {
                ...
                if (minutes != null && minutes > 0) {
                        ...
                        if (pomodoroSessionRepository != null) {
                                PomodoroSession session = PomodoroSession.builder().task(task)
        ...
        private void checkAutoFinish(Task task) {
                if (task.getExecutionTimeMinutes() != null && task.getExecutionTimeMinutes() > 0) {
                        ...
                        if (task.getMainStartedAt() != null) {
                                elapsed += java.time.Duration.between(task.getMainStartedAt(), LocalDateTime.now())
                                                .getSeconds();
                        }
                        if (elapsed >= targetSeconds
                                ...
                                eventPublisher.publishEvent(
                                                new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                                this,
                                                                task,
                                                                br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_TIME_UP,
                ...
                if (savedTask.getStatus() == TaskStatus.TODO) {
                        eventPublisher.publishEvent(
                                        new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                        this,
                                                        savedTask,
                                                        br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_CREATED,
        ...
        public TaskRecord updateTask(Long id, TaskCreateRecord taskCreate) {
                ...
                eventPublisher.publishEvent(
                                new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                this,
                                                updatedTask,
                                                br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_UPDATED,
                ...
                if (newStatus == TaskStatus.IN_PROGRESS) {
                        ...
                        if (isResumed) {
                                eventPublisher.publishEvent(
                                                new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                                this,
                                                                task,
                                                                br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_RESUMED,
                                ...
                                eventPublisher.publishEvent(
                                                new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                                this,
                                                                task,
                                                                br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_STARTED,
                        ...
                        eventPublisher.publishEvent(
                                        new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                        this,
                                                        task,
                                                        br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_PAUSED,
                        ...
                        if (newStatus == TaskStatus.DONE) {
                                ...
                                eventPublisher.publishEvent(
                                                new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                                this,
                                                                task,
                                                                br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_FINISHED,
        ...
        public TaskRecord changeTaskStatus(Long id, TaskStatus newStatus, User currentUser) {
                ...
                // timer)
                boolean isTimerRelatedStatus = newStatus == TaskStatus.IN_PROGRESS || newStatus == TaskStatus.IN_PAUSE;
        ...
        public Page<@NotNull TaskRecord> searchTasks(
                ...
                var filtered = all.stream()
                                .filter(
                                                t -> filter.getStatus() == null
                                                                || t.getStatus() == filter.getStatus())
                                .filter(
                                                t -> filter.getPriority() == null
                                                                || t.getPriority() == filter.getPriority())
                                .filter(
                                                t -> filter.getUserId() == null
                                                                || (t.getAssignedUser() != null
                                                                                && Objects.equals(
                                                                                                ...
                                                                                                filter.getUserId())))
                                .filter(
                                                t -> filter.getCategoryId() == null
                                                                || (t.getCategory() != null
                                                                                && Objects.equals(
                                                                                                t.getCategory().getId(),
                                                                                                filter.getCategoryId())))
                                .filter(
                                                t -> filter.getCreatedFrom() == null
                                                                || (t.getCreatedAt() != null
                                                                                && !t.getCreatedAt()
                                                                                                .toLocalDate()
                                                                                                .isBefore(filter.getCreatedFrom())))
                                .filter(
                                                t -> filter.getCreatedTo() == null
                                                                || (t.getCreatedAt() != null
                                                                                && !t.getCreatedAt()
                                                                                                .toLocalDate()
                                                                                                .isAfter(filter.getCreatedTo())))
                                .filter(
                                                t -> filter.getDueFrom() == null
                                                                || (t.getDueDate() != null
                                                                                && !t.getDueDate()
                                                                                                .toLocalDate()
                                                                                                .isBefore(filter.getDueFrom())))
                                .filter(
                                                t -> filter.getDueTo() == null
                                                                || (t.getDueDate() != null
                                                                                && !t.getDueDate()
                                                                                                .toLocalDate()
                ...
                List<TaskRecord> content = filtered.subList(start, end).stream().map(TaskServiceImpl::convertTo)
                                .toList();
        ...
        public Page<@NotNull TaskRecord> searchTasks(
                ...
                var filtered = visibleTasks.stream()
                                .filter(
                                                t -> filter.getStatus() == null
                                                                || t.getStatus() == filter.getStatus())
                                .filter(
        ...
        public TaskRecord extendTask(
                ...
                Integer currentExecution = task.getExecutionTimeMinutes() != null ? task.getExecutionTimeMinutes() : 0;
        ...
        public TaskRecord assignTaskToCurrentUser(Long taskId, User currentUser) {
                ...
                if (task.getSquad() != null) {
                        boolean isMember = squadMemberRepository.existsBySquadAndUser(task.getSquad(), currentUser);
                ...
                eventPublisher.publishEvent(
                                new br.com.rafaelvieira.taskmanagement.event.TaskEvent(
                                                ...
                                                savedTask,
                                                br.com.rafaelvieira.taskmanagement.domain.enums.NotificationType.TASK_UPDATED,
                                                currentUser.getFullName() + " assumiu a tarefa: "
                                                                + savedTask.getTitle()));
        ...
        @Override
        @Transactional(readOnly = true)
        public long countTasksByStatus(TaskStatus status, User currentUser) {
                if (currentUser.getRole() == Role.ADMIN) {
                        return taskRepository.countByStatus(status);
                } else if (currentUser.getRole() == Role.LEAD) {
                        return taskRepository.countByStatusForLead(status, currentUser);
                } else {
                        return taskRepository.countByStatusForMember(status, currentUser);
                }
        }

        @Override
        @Transactional(readOnly = true)
        public List<TaskRecord> getTasksByStatus(TaskStatus status, User currentUser) {
                List<Task> tasks;
                if (currentUser.getRole() == Role.ADMIN) {
                        tasks = taskRepository.findByStatus(status);
                } else if (currentUser.getRole() == Role.LEAD) {
                        tasks = taskRepository.findByStatusForLead(status, currentUser);
                } else {
                        tasks = taskRepository.findByStatusForMember(status, currentUser);
                }
                return tasks.stream().map(TaskServiceImpl::convertTo).toList();
        }
        ...
        @Override
        @Transactional(readOnly = true)
        public List<TaskRecord> getOverdueTasks(User currentUser) {
                List<Task> tasks;
                LocalDateTime now = LocalDateTime.now();
                if (currentUser.getRole() == Role.ADMIN) {
                        tasks = taskRepository.findOverdueTasks(now);
                } else if (currentUser.getRole() == Role.LEAD) {
                        tasks = taskRepository.findOverdueTasksForLead(now, currentUser);
                } else {
                        tasks = taskRepository.findOverdueTasksForMember(now, currentUser);
                }
                return tasks.stream().map(TaskServiceImpl::convertTo).toList();
        }
        ...
        @Override
        @Transactional(readOnly = true)
        public long countTasksByPriority(Priority priority, User currentUser) {
                if (currentUser.getRole() == Role.ADMIN) {
                        return taskRepository.findByPriority(priority).size();
                } else if (currentUser.getRole() == Role.LEAD) {
                        return taskRepository.countByPriorityForLead(priority, currentUser);
                } else {
                        return taskRepository.countByPriorityForMember(priority, currentUser);
                }
        }
}
